...
def get_dataloader(data_root, shot, trainsize, batchsize=32, num_workers=8, mode='train', mode2 = 0):
    ...
    if mode == 'train':
        ...
        if mode2 == 0:
            ...
            train_loader = data.DataLoader(train_data, batch_size=1, shuffle=False, num_workers=num_workers, pin_memory=True, sampler=None)
